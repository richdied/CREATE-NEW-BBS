              ...
              try {
            	  ...
            	  if(!skip) {
            		  if (client.indexOf("MSIE") != -1) {
            			  response.setHeader("Content-Disposition", "attachment; filename=" + new String(fileName.getBytes("KSC5601"), "iso-8859-1"));
            		  }else {
            		  ...
            		  out.println("<script>('파일을 찾을 수 없습니다.');history back();</script>");
            	  }
            	  in.close();
            	  os.close();
              } catch (Exception e) {
